...
def call_openai_for_executive_summary(all_analyses):
    ...
    try:
        ...
        summary_prompt = f"You are a senior brand strategist delivering a comprehensive executive summary for C-level executives. Based on the following six memorability key analyses, provide an extensive strategic assessment of 800-1200 words with detailed insights:\n\n## Required Sections (write 2-3 paragraphs per section):\n\n**1. Overall Assessment:** Provide a comprehensive overview of the brand's memorability performance across all six dimensions (Emotion, Attention, Story, Involvement, Repetition, Consistency). Analyze patterns, interdependencies, and overall brand coherence.\n\n**2. Key Strengths:** Identify and elaborate on the 2-3 strongest memorability keys. Explain in detail why they perform well, their strategic value, and how they contribute to brand recall and recognition.\n\n**3. Primary Weaknesses:** Conduct an in-depth analysis of the 2-3 weakest keys. Explain their deficiencies, potential impact on brand memorability, and why they're underperforming.\n\n**4. Strategic Recommendations:** Provide specific, actionable recommendations for each weak area. Include implementation strategies, resource requirements, and expected outcomes. Prioritize by impact and feasibility.\n\n**5. Implementation Roadmap:** Create a detailed priority framework. Identify the single most critical key to address first and provide a comprehensive strategic rationale with timeline considerations.\n\n**6. Competitive Positioning:** Assess how these memorability factors position the brand relative to industry standards. Include market context and differentiation opportunities.\n\nWrite each section with substantial detail, specific examples, and strategic insights. This is a formal executive briefing document - be thorough and professional.\n\n---\n{analyses_text}\n---"
