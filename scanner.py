...
def call_openai_for_executive_summary(all_analyses):
    ...
    try:
        ...
        summary_prompt = f"You are a senior brand strategist delivering a comprehensive executive summary. Based on the following six key analyses, please provide a detailed strategic assessment:\n\n1. **Overall Assessment:** A comprehensive overview of the brand's memorability performance across all six dimensions, highlighting patterns and interdependencies.\n\n2. **Key Strengths:** Identify and elaborate on the 2-3 strongest memorability keys, explaining why they perform well and their strategic value.\n\n3. **Primary Weaknesses:** Analyze the 2-3 weakest keys in detail, explaining their deficiencies and potential impact on brand memorability.\n\n4. **Strategic Recommendations:** Provide specific, actionable recommendations for each weak area, prioritized by impact and feasibility.\n\n5. **Implementation Priority:** Identify the single most critical key to address first and explain the strategic rationale.\n\n6. **Competitive Positioning:** Assess how these memorability factors position the brand relative to industry standards.\n\nPlease provide a thorough, professional analysis suitable for C-level executives.\n\n---\n{analyses_text}\n---"
